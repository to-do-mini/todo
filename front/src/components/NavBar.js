...
const NavBar = () => {
  ...
  return (
    ...
    //        <Link to class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">My List</Link>
         
    //        <Link to="/" className="" onClick={() => {setAuth(false)
    //             localStorage.removeItem("currentUser");}}> Logout  </Link>
    //      </div>
    //    </div>
    //  </div> 
